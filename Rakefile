...
asset_dir       = "source/assets"    # source file directory
...
task :generate do
  ...
  system "compass compile --css-dir #{asset_dir}/css"
  system "jekyll build"
end
...
task :clean do
  rm_rf [".pygments-cache/**", ".gist-cache/**", ".sass-cache/**", "#{asset_dir}/css/screen.css"]
end
